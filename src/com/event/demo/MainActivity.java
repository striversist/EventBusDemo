...
public class MainActivity extends Activity {
    ...
    public static final String TAG = "EventBusDemo";
    ...
    public void onEvent(PostEvent event) {
        Log.d(TAG, "OnEvent-->" + Thread.currentThread().getId());
    }
    ...
    public void onEventAsync(AsyncEvent event) {
        Log.d(TAG, "onEventAsync-->" + Thread.currentThread().getId());
    }
